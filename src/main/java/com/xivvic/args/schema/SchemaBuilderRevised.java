...
@Slf4j
public class SchemaBuilderRevised
{
	...
	public SchemaBuilderRevised()
	{
		this(FAIL_FAST);
	}

	public SchemaBuilderRevised(ErrorStrategy es)
	{
		this.es = es;
	}

	public SchemaBuilderRevised def(Map<String, String> def) throws SchemaException
	{
